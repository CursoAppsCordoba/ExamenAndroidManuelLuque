...
public class Alta_Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alta_);
    ...
    public Contactos crearContacto(View v){
        Contactos contactos = null;
        EditText nombre1=(EditText) findViewById(R.id.nombre);
        EditText email1=(EditText) findViewById(R.id.email);
        EditText edad1=(EditText) findViewById(R.id.edad);
